...
wget https://raw.githubusercontent.com/JBLeung/synology-ssr/master/res/config.json;
wget https://raw.githubusercontent.com/JBLeung/synology-ssr/master/res/util.py;
